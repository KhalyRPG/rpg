...
public class UserImpl implements User {
	...
	//@Override
	/*protected UserAttributes getAttributes() {
		return attributes;
	}*/
	...
	private void setupModifiers() {
		addModifier(
				...
				StatAttribute.CURSED_ENERGY,
				StatAttribute.ATTACK_SPEED,
				StatAttribute.HEALTH_REGEN,
				StatAttribute.MANA_REGEN,
				StatAttribute.SPEED
				);
		
		addModifierWithClass(
				StatAttribute.HEALTH,
				StatAttribute.INTELLIGENCE,
				StatAttribute.STRENGTH,
				StatAttribute.MELEE_DAMAGE,
				StatAttribute.RANGED_DAMAGE
				);
